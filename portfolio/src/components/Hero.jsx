...
const Hero = () => {
  ...
  const roles = [title, "AI Agent Systems Builder", "MERN Stack Specialist", "Problem Solver"];
        ...
        <div className="terminal-window glass-panel">
          ...
          <div className="terminal-body">
            ...
            <div className="terminal-line">
              ...
              <span className="terminal-accent">LangGraph, Python, MERN</span>
            </div>
            <div className="terminal-line">
              <span className="terminal-output">Focus: </span>
              <span className="terminal-accent">Multi-Agent AI & RAG Systems</span>
            </div>
            <div className="terminal-line">
